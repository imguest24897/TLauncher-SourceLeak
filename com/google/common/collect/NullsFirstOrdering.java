...
/* 82 */     String str = String.valueOf(this.ordering); return (new StringBuilder(13 + String.valueOf(str).length())).append(str).append(".nullsFirst()").toString();
/*    */   }
/*    */ }


/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\common\collect\NullsFirstOrdering.class
