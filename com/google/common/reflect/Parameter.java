...
/*  97 */     return (Annotation[])this.annotations.toArray((Object[])new Annotation[0]);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 137 */     String str = String.valueOf(this.type); int i = this.position; return (new StringBuilder(15 + String.valueOf(str).length())).append(str).append(" arg").append(i).toString();
/*     */   }
/*     */ }


/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\common\reflect\Parameter.class
