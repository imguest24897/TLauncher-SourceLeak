...
/* 105 */       String str = String.valueOf(localTask); return (new StringBuilder(7 + String.valueOf(str).length())).append("task=[").append(str).append("]").toString();
/*     */     } 
...
/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\commo\\util\concurrent\TrustedListenableFutureTask.class
