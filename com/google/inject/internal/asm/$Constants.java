...
/* 194 */     if (!internalName.startsWith("com/google/inject/internal/asm/")) {
/* 195 */       return false;
/*     */     }
/* 197 */     String member = "(Annotation|Class|Field|Method|Module|RecordComponent|Signature)";
/* 198 */     return (internalName.contains("Test$") || 
/* 199 */       Pattern.matches("com/google/inject/internal/asm/util/$Trace" + member + "Visitor(\\$.*)?", internalName) || 
/*     */       
/* 201 */       Pattern.matches("com/google/inject/internal/asm/util/$Check" + member + "Adapter(\\$.*)?", internalName));
/*     */   }
/*     */   
...
/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\inject\internal\asm\$Constants.class
