...
/* 136 */     Validate.isTrue((ellipsis == null || precision < 0 || ellipsis.length() <= precision), "Specified ellipsis '%1$s' exceeds precision of %2$s", new Object[] { ellipsis, 
/* 137 */           Integer.valueOf(precision) });
/* 138 */     StringBuilder buf = new StringBuilder(seq);
/* 139 */     if (precision >= 0 && precision < seq.length()) {
/* 140 */       CharSequence actualEllipsis = (CharSequence)ObjectUtils.defaultIfNull(ellipsis, "");
...
/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\org\apache\commons\lang3\text\FormattableUtils.class
