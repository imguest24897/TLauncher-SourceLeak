...
/* 343 */       throw new NumberFormatException((new StringBuilder(26)).append("illegal radix: ").append(radix).toString());
/*     */     }
/*     */     
...
/* 354 */         String.valueOf(string); throw new NumberFormatException((String.valueOf(string).length() != 0) ? "Too large for unsigned long: ".concat(String.valueOf(string)) : new String("Too large for unsigned long: "));
/*     */       } 
...
/* 385 */       String.valueOf(stringValue); NumberFormatException decodeException = new NumberFormatException((String.valueOf(stringValue).length() != 0) ? "Error parsing value: ".concat(String.valueOf(stringValue)) : new String("Error parsing value: "));
/*     */       
...
/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\common\primitives\UnsignedLongs.class
