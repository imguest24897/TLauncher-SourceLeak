...
/*  37 */     return Pattern.compile(regex, 32);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  86 */     return replaceAll(text, regex, "");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 132 */     return replaceAll(text, regex, "");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 168 */     return replaceFirst(text, regex, "");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 213 */     return replaceFirst(text, regex, "");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 244 */     return replacePattern(text, regex, "");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 284 */     if (ObjectUtils.anyNull(new Object[] { text, regex, replacement })) {
/* 285 */       return text;
/*     */     }
...
/* 338 */     if (ObjectUtils.anyNull(new Object[] { text, regex, replacement })) {
/* 339 */       return text;
/*     */     }
...
/* 477 */     if (ObjectUtils.anyNull(new Object[] { text, regex, replacement })) {
/* 478 */       return text;
/*     */     }
...
/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\org\apache\commons\lang3\RegExUtils.class
