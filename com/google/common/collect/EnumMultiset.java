...
/* 113 */       String str1 = String.valueOf(this.type), str2 = String.valueOf(element); throw new ClassCastException((new StringBuilder(21 + String.valueOf(str1).length() + String.valueOf(str2).length())).append("Expected an ").append(str1).append(" but got ").append(str2).toString());
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/* 241 */         EnumMultiset.this.size -= EnumMultiset.this.counts[this.toRemove];
...
/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\common\collect\EnumMultiset.class
