...
/*     */ 
/*     */           
/* 205 */           String str1 = String.valueOf(fromClass), str2 = String.valueOf(to); throw new IllegalArgumentException((new StringBuilder(25 + String.valueOf(str1).length() + String.valueOf(str2).length())).append("No type mapping from ").append(str1).append(" to ").append(str2).toString());
/*     */         }
...
/* 272 */       String str1 = String.valueOf(arg), str2 = type.getSimpleName(); throw new IllegalArgumentException((new StringBuilder(10 + String.valueOf(str1).length() + String.valueOf(str2).length())).append(str1).append(" is not a ").append(str2).toString());
/*     */     } 
/*     */   }
/*     */   
...
/* 303 */       TypeTable guarded = new TypeTable(this)
/*     */         {
...
/* 502 */       int i = this.id.incrementAndGet(); String str1 = Joiner.on('&').join((Object[])upperBounds), name = (new StringBuilder(33 + String.valueOf(str1).length())).append("capture#").append(i).append("-of ? extends ").append(str1).toString();
...
/* 507 */       return new WildcardCapturer(this, this.id)
/*     */         {
/*     */           TypeVariable<?> captureAsTypeVariable(Type[] upperBounds) {
...
/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\common\reflect\TypeResolver.class
