...
/*     */         }
/* 262 */         char c3 = c2; int j = index; String str1 = String.valueOf(seq); throw new IllegalArgumentException((new StringBuilder(89 + String.valueOf(str1).length())).append("Expected low surrogate but got char '").append(c2).append("' with value ").append(c3).append(" at index ").append(j).append(" in '").append(str1).append("'").toString());
/*     */       } 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */       
/* 273 */       char c = c1; int i = index - 1; String str = String.valueOf(seq); throw new IllegalArgumentException((new StringBuilder(88 + String.valueOf(str).length())).append("Unexpected low surrogate character '").append(c1).append("' with value ").append(c).append(" at index ").append(i).append(" in '").append(str).append("'").toString());
/*     */     } 
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\common\escape\UnicodeEscaper.class
