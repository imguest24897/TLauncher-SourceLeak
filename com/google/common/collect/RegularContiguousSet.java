...
/*  45 */       ContiguousSet.<C>create(this.range.intersection(other), this.domain) : 
/*  46 */       new EmptyContiguousSet<>(this.domain);
/*     */   }
/*     */ 
/*     */   
...
/* 175 */       return other;
/*     */     }
/* 177 */     Comparable<Comparable> comparable1 = (Comparable)Ordering.<Comparable>natural().max(first(), (Comparable)other.first());
/* 178 */     Comparable<Comparable> comparable2 = (Comparable)Ordering.<Comparable>natural().min(last(), (Comparable)other.last());
/* 179 */     return (comparable1.compareTo(comparable2) <= 0) ? 
/* 180 */       ContiguousSet.<C>create((Range)Range.closed(comparable1, comparable2), this.domain) : 
/* 181 */       new EmptyContiguousSet<>(this.domain);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\common\collect\RegularContiguousSet.class
