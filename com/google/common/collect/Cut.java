...
/*     */     
/*     */     public String toString() {
/* 376 */       String str = String.valueOf(this.endpoint); return (new StringBuilder(2 + String.valueOf(str).length())).append("\\").append(str).append("/").toString();
...
/*     */     
/*     */     public String toString() {
/* 465 */       String str = String.valueOf(this.endpoint); return (new StringBuilder(2 + String.valueOf(str).length())).append("/").append(str).append("\\").toString();
/*     */     } }
/*     */ 
/*     */ }


/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\common\collect\Cut.class
