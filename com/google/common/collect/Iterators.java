...
/*  801 */       throw new IndexOutOfBoundsException((new StringBuilder(91)).append("position (").append(position).append(") must be less than the number of elements that remained (").append(skipped).append(")").toString());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  831 */     if (position < 0) {
/*  832 */       throw new IndexOutOfBoundsException((new StringBuilder(43)).append("position (").append(position).append(") must not be negative").toString());
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1079 */     Preconditions.checkNotNull(enumeration);
...
/* 1100 */     Preconditions.checkNotNull(iterator);
...
/* 1122 */       this.iterator = (Iterator<? extends E>)Preconditions.checkNotNull(iterator);
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean hasNext() {
/* 1127 */       return (this.hasPeeked || this.iterator.hasNext());
/*      */     }
/*      */ 
/*      */     
/*      */     public E next() {
/* 1132 */       if (!this.hasPeeked) {
/* 1133 */         return this.iterator.next();
/*      */       }
/* 1135 */       E result = this.peekedElement;
/* 1136 */       this.hasPeeked = false;
/* 1137 */       this.peekedElement = null;
/* 1138 */       return result;
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
/* 1143 */       Preconditions.checkState(!this.hasPeeked, "Can't remove after you've peeked at next");
/* 1144 */       this.iterator.remove();
/*      */     }
/*      */ 
/*      */     
/*      */     public E peek() {
/* 1149 */       if (!this.hasPeeked) {
/* 1150 */         this.peekedElement = this.iterator.next();
/* 1151 */         this.hasPeeked = true;
/*      */       } 
/* 1153 */       return this.peekedElement;
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */ 
/*      */       
/* 1198 */       PeekingImpl<T> peeking = (PeekingImpl)iterator;
/* 1199 */       return peeking;
/*      */     } 
/* 1201 */     return new PeekingImpl<>(iterator);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1212 */     return (PeekingIterator<T>)Preconditions.checkNotNull(iterator);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1230 */     Preconditions.checkNotNull(iterators, "iterators");
/* 1231 */     Preconditions.checkNotNull(comparator, "comparator");
/*      */     
/* 1233 */     return new MergingIterator<>(iterators, comparator);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1253 */       Comparator<PeekingIterator<T>> heapComparator = (Comparator)new Comparator<PeekingIterator<PeekingIterator<T>>>(this)
/*      */         {
...
/*      */         };
/*      */       
/* 1261 */       this.queue = new PriorityQueue<>(2, heapComparator);
/*      */       
/* 1263 */       for (Iterator<? extends T> iterator : iterators) {
/* 1264 */         if (iterator.hasNext()) {
/* 1265 */           this.queue.add(Iterators.peekingIterator(iterator));
/*      */         }
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean hasNext() {
/* 1272 */       return !this.queue.isEmpty();
/*      */     }
/*      */ 
/*      */     
/*      */     public T next() {
/* 1277 */       PeekingIterator<T> nextIter = this.queue.remove();
/* 1278 */       T next = nextIter.next();
/* 1279 */       if (nextIter.hasNext()) {
/* 1280 */         this.queue.add(nextIter);
/*      */       }
/* 1282 */       return next;
/*      */     }
/*      */   }
...
/* 1306 */       this.iterator = Iterators.emptyIterator();
/* 1307 */       this.topMetaIterator = (Iterator<? extends Iterator<? extends T>>)Preconditions.checkNotNull(metaIterator);
/*      */     }
/*      */ 
/*      */     
/*      */     private Iterator<? extends Iterator<? extends T>> getTopMetaIterator() {
/* 1312 */       while (this.topMetaIterator == null || !this.topMetaIterator.hasNext()) {
/* 1313 */         if (this.metaIterators != null && !this.metaIterators.isEmpty()) {
/* 1314 */           this.topMetaIterator = this.metaIterators.removeFirst(); continue;
/*      */         } 
/* 1316 */         return null;
/*      */       } 
/*      */       
/* 1319 */       return this.topMetaIterator;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean hasNext() {
/* 1324 */       while (!((Iterator)Preconditions.checkNotNull(this.iterator)).hasNext()) {
/*      */ 
/*      */ 
/*      */         
/* 1328 */         this.topMetaIterator = getTopMetaIterator();
/* 1329 */         if (this.topMetaIterator == null) {
/* 1330 */           return false;
/*      */         }
/*      */         
/* 1333 */         this.iterator = this.topMetaIterator.next();
/*      */         
/* 1335 */         if (this.iterator instanceof ConcatenatedIterator) {
/*      */ 
/*      */ 
/*      */           
/* 1339 */           ConcatenatedIterator<T> topConcat = (ConcatenatedIterator)this.iterator;
/* 1340 */           this.iterator = topConcat.iterator;
/*      */ 
/*      */ 
/*      */ 
/*      */           
...
/*      */     public T next() {
/* 1362 */       if (hasNext()) {
/* 1363 */         this.toRemove = this.iterator;
/* 1364 */         return this.iterator.next();
/*      */       } 
...
/*      */     
/*      */     public void remove() {
/* 1372 */       CollectPreconditions.checkRemove((this.toRemove != null));
/* 1373 */       this.toRemove.remove();
/* 1374 */       this.toRemove = null;
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\common\collect\Iterators.class
