...
/* 300 */       String str = String.valueOf(this.original); return (new StringBuilder(10 + String.valueOf(str).length())).append(str).append(".reverse()").toString();
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/*     */     public String toString() {
/* 377 */       String str1 = String.valueOf(this.first), str2 = String.valueOf(this.second); return (new StringBuilder(10 + String.valueOf(str1).length() + String.valueOf(str2).length())).append(str1).append(".andThen(").append(str2).append(")").toString();
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/*     */     public String toString() {
/* 470 */       String str1 = String.valueOf(this.forwardFunction), str2 = String.valueOf(this.backwardFunction); return (new StringBuilder(18 + String.valueOf(str1).length() + String.valueOf(str2).length())).append("Converter.from(").append(str1).append(", ").append(str2).append(")").toString();
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 477 */     return (Converter)IdentityConverter.INSTANCE;
/*     */   }
/*     */ 
/*     */   
...
/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\common\base\Converter.class
