...
/*     */       
/* 159 */       String str1 = String.valueOf(getReturnType()), str2 = String.valueOf(returnType); throw new IllegalArgumentException((new StringBuilder(35 + String.valueOf(str1).length() + String.valueOf(str2).length())).append("Invokable is known to return ").append(str1).append(", not ").append(str2).toString());
/*     */     } 
/*     */     
...
/* 275 */         String str = String.valueOf(this.constructor); throw new RuntimeException((new StringBuilder(8 + String.valueOf(str).length())).append(str).append(" failed.").toString(), e);
/*     */       } 
/*     */     }
/*     */ 
/*     */ 
...
/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\common\reflect\Invokable.class
