...
/*  75 */       String str = String.valueOf(this.url); return (new StringBuilder(24 + String.valueOf(str).length())).append("Resources.asByteSource(").append(str).append(")").toString();
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 208 */     Preconditions.checkArgument((url != null), "resource %s relative to %s not found.", resourceName, contextClass
/* 209 */         .getName());
/* 210 */     return url;
/*     */   }
/*     */ }
...
/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\common\io\Resources.class
