...
/* 304 */       String finalizerPath = String.valueOf("com.google.common.base.internal.Finalizer".replace('.', '/')).concat(".class");
...
/* 313 */         String.valueOf(urlString); throw new IOException((String.valueOf(urlString).length() != 0) ? "Unsupported path style: ".concat(String.valueOf(urlString)) : new String("Unsupported path style: "));
/*     */       } 
...
/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\common\base\FinalizableReferenceQueue.class
