...
/*  87 */     this.map.put(Character.valueOf(c), (String)Preconditions.checkNotNull(r));
/*  88 */     if (c > this.max) {
/*  89 */       this.max = c;
/*     */     }
/*  91 */     return this;
...
/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\common\escape\CharEscaperBuilder.class
