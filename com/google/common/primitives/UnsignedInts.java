...
/* 321 */       String.valueOf(stringValue); NumberFormatException decodeException = new NumberFormatException((String.valueOf(stringValue).length() != 0) ? "Error parsing value: ".concat(String.valueOf(stringValue)) : new String("Error parsing value: "));
/*     */       
...
/* 360 */       throw new NumberFormatException((new StringBuilder(69 + String.valueOf(string).length())).append("Input ").append(string).append(" in base ").append(radix).append(" is not in the range of an unsigned integer").toString());
/*     */     }
/*     */     
...
/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\common\primitives\UnsignedInts.class
