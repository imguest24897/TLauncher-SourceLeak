...
/* 188 */       String str = String.valueOf(localInputFuture); resultString = (new StringBuilder(16 + String.valueOf(str).length())).append("inputFuture=[").append(str).append("], ").toString();
/*     */     } 
/* 190 */     if (localFunction != null) {
/* 191 */       String str1 = resultString, str2 = String.valueOf(localFunction); return (new StringBuilder(11 + String.valueOf(str1).length() + String.valueOf(str2).length())).append(str1).append("function=[").append(str2).append("]").toString();
/* 192 */     }  if (superString != null) {
/* 193 */       String.valueOf(superString); return (String.valueOf(superString).length() != 0) ? String.valueOf(resultString).concat(String.valueOf(superString)) : new String(String.valueOf(resultString));
/*     */     } 
/* 195 */     return null;
/*     */   }
/*     */ 
...
/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\commo\\util\concurrent\AbstractTransformFuture.class
