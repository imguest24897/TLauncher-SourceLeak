...
/* 181 */     munch();
/* 182 */     Java8Compatibility.flip(this.buffer);
/* 183 */     if (this.buffer.remaining() > 0) {
/* 184 */       processRemaining(this.buffer);
/* 185 */       Java8Compatibility.position(this.buffer, this.buffer.limit());
/*     */     } 
/* 187 */     return makeHash();
/*     */   }
/*     */ 
...
/*     */   
/*     */   private void munch() {
/* 206 */     Java8Compatibility.flip(this.buffer);
...
/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\common\hash\AbstractStreamingHasher.class
