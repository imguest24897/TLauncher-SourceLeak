...
/*    */       
/* 41 */       boolean match = ((caseSensitive && n.startsWith(string)) || (!caseSensitive && n.toLowerCase().startsWith(string.toLowerCase())));
/* 42 */       if (match) {
...
/* 49 */       throw new ParameterException("Ambiguous option: " + name + " matches " + results
/* 50 */           .keySet()); 
...
/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\beust\jcommander\FuzzyMap.class
