...
/*  40 */       if (oldValue != null) {
/*  41 */         String str1 = String.valueOf(e.getKey()), str2 = String.valueOf(oldValue); throw conflictException("key", (new StringBuilder(1 + String.valueOf(str1).length() + String.valueOf(str2).length())).append(str1).append("=").append(str2).toString(), entryArray[i]);
/*     */       } 
/*  43 */       K oldKey = backwardDelegate.putIfAbsent(e.getValue(), e.getKey());
/*  44 */       if (oldKey != null) {
/*  45 */         String str1 = String.valueOf(oldKey), str2 = String.valueOf(e.getValue()); throw conflictException("value", (new StringBuilder(1 + String.valueOf(str1).length() + String.valueOf(str2).length())).append(str1).append("=").append(str2).toString(), entryArray[i]);
/*     */       } 
/*     */     } 
...
/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\common\collect\JdkBackedImmutableBiMap.class
