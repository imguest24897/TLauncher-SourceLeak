...
/*  156 */       (Collection)removeFrom).removeAll((Collection)Preconditions.checkNotNull(elementsToRemove)) : 
...
/*  173 */       (Collection)removeFrom).retainAll((Collection)Preconditions.checkNotNull(elementsToRetain)) : 
...
/*      */         
/*      */         public String toString() {
/*  376 */           return String.valueOf(iterable.toString()).concat(" (cycled)");
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\common\collect\Iterables.class
