...
/*     */     
/*     */     public String toString() {
/* 187 */       String str = String.valueOf(this.elementFunnel); return (new StringBuilder(26 + String.valueOf(str).length())).append("Funnels.sequentialFunnel(").append(str).append(")").toString();
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean equals(Object o) {
...
/*     */     
/*     */     public String toString() {
/* 266 */       String str = String.valueOf(this.sink); return (new StringBuilder(24 + String.valueOf(str).length())).append("Funnels.asOutputStream(").append(str).append(")").toString();
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\common\hash\Funnels.class
