...
/* 122 */     Preconditions.checkNotNull(edge);
/* 123 */     Preconditions.checkNotNull(node);
/*     */     
/* 125 */     if (isSelfLoop) {
/* 126 */       Graphs.checkPositive(++this.selfLoopCount);
/*     */     }
/* 128 */     N previousNode = this.inEdgeMap.put(edge, node);
/* 129 */     Preconditions.checkState((previousNode == null));
/*     */   }
/*     */ 
/*     */   
/*     */   public void addOutEdge(E edge, N node) {
/* 134 */     Preconditions.checkNotNull(edge);
/* 135 */     Preconditions.checkNotNull(node);
/*     */     
/* 137 */     N previousNode = this.outEdgeMap.put(edge, node);
/* 138 */     Preconditions.checkState((previousNode == null));
/*     */   }
/*     */ }


/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\common\graph\AbstractDirectedNetworkConnections.class
