...
/* 101 */     String str = this.element.toString(); return (new StringBuilder(2 + String.valueOf(str).length())).append('[').append(str).append(']').toString();
/*     */   }
/*     */ }


/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\common\collect\SingletonImmutableSet.class
