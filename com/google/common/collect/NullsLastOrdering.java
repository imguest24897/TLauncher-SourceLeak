...
/* 82 */     String str = String.valueOf(this.ordering); return (new StringBuilder(12 + String.valueOf(str).length())).append(str).append(".nullsLast()").toString();
/*    */   }
/*    */ }


/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\common\collect\NullsLastOrdering.class
