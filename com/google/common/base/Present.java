...
/* 95 */     String str = String.valueOf(this.reference); return (new StringBuilder(13 + String.valueOf(str).length())).append("Optional.of(").append(str).append(")").toString();
/*    */   }
/*    */ }


/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\common\base\Present.class
