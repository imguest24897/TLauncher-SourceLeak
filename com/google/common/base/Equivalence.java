...
/* 237 */       String str1 = String.valueOf(this.equivalence), str2 = String.valueOf(this.reference); return (new StringBuilder(7 + String.valueOf(str1).length() + String.valueOf(str2).length())).append(str1).append(".wrap(").append(str2).append(")").toString();
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/*     */     public String toString() {
/* 305 */       String str1 = String.valueOf(this.equivalence), str2 = String.valueOf(this.target); return (new StringBuilder(15 + String.valueOf(str1).length() + String.valueOf(str2).length())).append(str1).append(".equivalentTo(").append(str2).append(")").toString();
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\common\base\Equivalence.class
