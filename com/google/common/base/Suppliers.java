...
/*  79 */       String str1 = String.valueOf(this.function), str2 = String.valueOf(this.supplier); return (new StringBuilder(21 + String.valueOf(str1).length() + String.valueOf(str2).length())).append("Suppliers.compose(").append(str1).append(", ").append(str2).append(")").toString();
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 107 */       new MemoizingSupplier<>(delegate) : 
/* 108 */       new NonSerializableMemoizingSupplier<>(delegate);
/*     */   }
/*     */   
/*     */   @VisibleForTesting
...
/*     */     
/*     */     public String toString() {
/* 142 */       String str = String.valueOf(this.value); str = String.valueOf(this.initialized ? (new StringBuilder(25 + String.valueOf(str).length())).append("<supplier that returned ").append(str).append(">").toString() : this.delegate); return (new StringBuilder(19 + String.valueOf(str).length())).append("Suppliers.memoize(").append(str).append(")").toString();
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/*     */       
/* 183 */       String str = String.valueOf(this.value); str = String.valueOf((delegate == null) ? (new StringBuilder(25 + String.valueOf(str).length())).append("<supplier that returned ").append(str).append(">").toString() : delegate); return (new StringBuilder(19 + String.valueOf(str).length())).append("Suppliers.memoize(").append(str).append(")").toString();
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/*     */     public String toString() {
/* 260 */       String str = String.valueOf(this.delegate); long l = this.durationNanos; return (new StringBuilder(62 + String.valueOf(str).length())).append("Suppliers.memoizeWithExpiration(").append(str).append(", ").append(l).append(", NANOS)").toString();
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/*     */     public String toString() {
/* 299 */       String str = String.valueOf(this.instance); return (new StringBuilder(22 + String.valueOf(str).length())).append("Suppliers.ofInstance(").append(str).append(")").toString();
/*     */     } }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/*     */     public String toString() {
/* 329 */       String str = String.valueOf(this.delegate); return (new StringBuilder(32 + String.valueOf(str).length())).append("Suppliers.synchronizedSupplier(").append(str).append(")").toString();
/*     */     } }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\vovanchik\Downloads\TLauncher.jar!\com\google\common\base\Suppliers.class
